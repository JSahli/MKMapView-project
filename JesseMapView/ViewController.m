...
//    [NSTimer scheduledTimerWithTimeInterval:3.0 target:self selector:@selector(setStartLocation) userInfo:nil repeats:NO];
...
//                NSLog(@"Name: %@, Placemark title: %@", [mapItem name], [[mapItem placemark] location]);
